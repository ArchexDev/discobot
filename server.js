...
client.login("ODM2MjA5MTAwMTUzMDI4NjU5.YIaqaQ.Jpth9nE2URe2uk3v1A8iZxEpvGA").catch(error => { console.log("token yanlış birader.") }); // .env dosyasında token yerinin karşısına token gir.
